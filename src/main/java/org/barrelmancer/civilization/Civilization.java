...
public final class Civilization extends JavaPlugin {
    ...
    private static BukkitTask thirstBarTask;
    private static BukkitTask thirstTask;

    private static BukkitTask temperatureBarTask;
    ...
    public void onDisable() {
        ...
        if (thirstBarTask != null && !thirstBarTask.isCancelled()) {
            thirstBarTask.cancel();
        }
